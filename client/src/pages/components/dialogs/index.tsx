  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>Show an alert to the user to convey something or make the user choose from the given options.</Typography>
          <DialogAlert />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You can set a dialog maximum width by using the <code>maxWidth</code> enumerable in combination with the <code>fullWidth</code> boolean.
            When the <code>fullWidth</code> property is true, the dialog will adapt based on the <code>maxWidth</code> value.
          </Typography>
          <DialogSizes />
        </CardSnippet>
      </Grid>
