  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>size={`{'small' | 'medium' | 'large'}`}</code> prop with <code>&lt;ButtonGroup&gt;</code> component for different sizes of
            button groups.
          </Typography>
          <ButtonGroupSizes />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            <code>ButtonGroup</code> can also be used to create a split button. The dropdown can change the button action (as in this example), or be
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with <code>&lt;ToggleButtonGroup&gt;</code> component with the help of a state and use{' '}
            <code>exclusive</code> prop with <code>&lt;ToggleButtonGroup&gt;</code> component.
          </Typography>
          <ButtonToggleSimple />
        </CardSnippet>
      </Grid>
