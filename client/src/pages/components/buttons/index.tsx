  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use an icon component inside <code>&lt;IconButton&gt;</code> component. For different colors, use <code>color</code> prop with{' '}
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>size={`{'small' | 'medium' | 'large'}`}</code> prop with <code>&lt;Button&gt;</code> component for different sized buttons. To
            use icon buttons, you need to use <code>size={`{small | large}`}</code> prop with <code>&lt;IconButton&gt;</code> component or you can
            also use <code>fontSize</code> prop with the icons.
          </Typography>
          <ButtonsSizes />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>color</code> prop with <code>&lt;Fab&gt;</code> component for different colored Floating Action Button and{' '}
            <code>variant='extended'</code> prop for extended (not round) Floating Action Button.
          </Typography>
          <ButtonsFab />
        </CardSnippet>
      </Grid>
