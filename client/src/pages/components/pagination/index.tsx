  ...
  return (
    <GridContainer container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use the following props with <code>Pagination</code> component: <code>count</code> prop for number of page items and <code>color</code>{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>showFirstButton</code> & <code>showLastButton</code> props to show first-page and last-page buttons and{' '}
            <code>hidePrevButton</code> & <code>hideNextButton</code> props to hide previous-page and next-page buttons.
          </Typography>
          <PaginationButtons />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You can specify how many digits to display either side of current page with the <code>siblingRange</code> prop, and adjacent to the start
            and end page number with the <code>boundaryRange</code> prop.
          </Typography>
          <PaginationRanges />
        </CardSnippet>
      </Grid>
