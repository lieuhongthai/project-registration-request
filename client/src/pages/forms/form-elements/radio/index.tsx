  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            <code>RadioGroup</code> is a helpful wrapper used to group <code>Radio</code> components that provides an easier API, and proper keyboard
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with <code>RadioGroup</code> component with the help of a state for controlled radio and{' '}
            <code>defaultValue</code> prop with <code>RadioGroup</code> component for uncontrolled radio.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            In general, radio buttons should have a value selected by default. If this is not the case, you can display an error if no value is
