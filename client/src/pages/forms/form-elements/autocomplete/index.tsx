  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>variant={`{'filled' | 'standard'}`}</code> prop with <code>TextField</code> component in <code>renderInput</code> prop with{' '}
            <code>Autocompletes</code> component for different variants of input. Use <code>disabled</code> prop with <code>Autocompletes</code>{' '}
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>value</code> prop with <code>Autocompletes</code> component for controlled autocomplete input.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Each of the following examples demonstrate one feature of <code>Autocompletes</code> component.
          </Typography>
          <AutocompleteProps />
        </CardSnippet>
      </Grid>
