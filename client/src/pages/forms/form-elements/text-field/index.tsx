  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Standard form attributes are supported e.g. <code>required</code>, <code>disabled</code>, <code>type</code>, etc. as well as{' '}
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            <code>color={`{'secondary' | 'success' | 'error' | 'warning' | 'info'}`}</code> prop changes the highlight color of the text field when
            focused.
          </Typography>
          <TextFieldColor />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            The main way is with an <code>InputAdornment</code>. This can be used to add a prefix, a suffix or an action to an input. For instance,
      ...
      <Grid item xs={12}>
        ...
        >
          ...
          <Typography sx={{ mb: 4 }}>
            <code>margin</code> prop can be used to alter the vertical spacing of inputs. Using <code>none</code> (default) doesn't apply margins to
            the <code>FormControl</code> whereas <code>dense</code> and <code>normal</code> do.
          </Typography>
          <TextFieldLayout />
        </CardSnippet>
      </Grid>
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            <code>TextField</code> is composed of smaller components (<code>FormControl</code>, <code>Input</code>, <code>FilledInput</code>,{' '}
            <code>InputLabel</code>, <code>OutlinedInput</code>, and <code>FormHelperText</code>) that you can leverage directly to significantly
            customize your form inputs.
          </Typography>
          <TextFieldComponents />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            The <code>error</code> prop toggles the error state, the <code>helperText</code> prop can then be used to provide feedback to the user
            about the error.
          </Typography>
          <TextFieldValidation />
        </CardSnippet>
