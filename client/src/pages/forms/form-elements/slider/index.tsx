  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with the help of a state for controlled slider and use <code>defaultValue</code> prop for uncontrolled
            slider.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            The slider can be used to set the start and end of a range by supplying an array of values to the <code>value</code> or{' '}
