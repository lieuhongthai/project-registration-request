  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>minRows</code> prop with <code>TextareaAutosize</code> component to add minimum rows in textarea and <code>maxRows</code> prop
            to add maximum rows.
          </Typography>
          <TextareaBasic />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>multiline</code> prop with <code>TextField</code> component to transform the text field into <code>textarea</code>. Use{' '}
            <code>variant</code> prop with <code>TextField</code> component for different variants of textarea.
          </Typography>
          <TextareaVariant />
        </CardSnippet>
      </Grid>
