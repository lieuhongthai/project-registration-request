  ...
  return (
    <Card>
      <CardContent sx={{ textAlign: 'center', '& svg': { mb: 2 } }}>
        ...
        <Typography sx={{ mb: 3 }}>Use Refer & Earn modal to encourage your exiting customers refer their friends & colleague.</Typography>
      ...
      >
        <DialogContent sx={{ pb: 10, px: [8, 15], pt: [8, 12.5], position: 'relative' }}>
          ...
          <Box sx={{ mb: 10, textAlign: 'center' }}>
            ...
            <Typography variant='body2'>Invite your friend to vuexy, if thay sign up, you and your friend will get 30 days free trial</Typography>
          </Box>
        ...
        <DialogContent sx={{ pt: 7.5, px: [8, 15], pb: [8, 12.5], position: 'relative' }}>
          <Box sx={{ mb: 8 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', width: '100%', flexWrap: { xs: 'wrap', sm: 'nowrap' } }}>
              <TextField fullWidth size='small' id='refer-email' sx={{ mr: { xs: 0, sm: 4 } }} placeholder='johnDoe@email.com' />
