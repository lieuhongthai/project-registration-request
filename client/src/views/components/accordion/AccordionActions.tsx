  ...
  return (
    <div>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary id='actions-panel-header-1' aria-controls='actions-panel-content-1' expandIcon={<Icon icon='mdi:chevron-down' />}>
          <FormControlLabel
            label='Accordion 1'
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary id='actions-panel-header-2' aria-controls='actions-panel-content-2' expandIcon={<Icon icon='mdi:chevron-down' />}>
          <FormControlLabel
            label='Accordion 2'
            aria-label='Acknowledge'
            control={<Checkbox disableRipple />}
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary id='actions-panel-header-3' aria-controls='actions-panel-content-3' expandIcon={<Icon icon='mdi:chevron-down' />}>
          <FormControlLabel
            label='Accordion 3'
            aria-label='Acknowledge'
            control={<Checkbox disableRipple />}
