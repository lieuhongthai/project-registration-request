  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12} sm={6} lg={4}>
        ...
        <Cleave id='date' placeholder='2001-01-01' options={{ date: true, delimiter: '-', datePattern: ['Y', 'm', 'd'] }} />
      </Grid>
      <Grid item xs={12} sm={6} lg={4}>
      ...
      <Grid item xs={12} sm={6} lg={4}>
        ...
        <Cleave id='delimiter' placeholder="Delimiter: '.'" options={{ delimiter: '·', blocks: [3, 3, 3], uppercase: true }} />
      </Grid>
      <Grid item xs={12} sm={6} lg={4}>
